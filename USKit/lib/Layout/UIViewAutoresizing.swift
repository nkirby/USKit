...
public struct UIViewAutoresizing : OptionSetType {
    ...
    public static var FlexibleTopMargin = UIViewAutoresizing(rawValue: NSAutoresizingMaskOptions.ViewMaxYMargin.rawValue)
    public static var FlexibleHeight = UIViewAutoresizing(rawValue: NSAutoresizingMaskOptions.ViewHeightSizable.rawValue)
    public static var FlexibleBottomMargin = UIViewAutoresizing(rawValue: NSAutoresizingMaskOptions.ViewMinYMargin.rawValue)
